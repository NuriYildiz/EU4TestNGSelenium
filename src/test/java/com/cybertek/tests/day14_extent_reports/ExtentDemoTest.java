...
public class ExtentDemoTest {           //you do not need to know each line of this code
    ...
    public void test1(){
        ...
        extentLogger= report.createTest("TC123 Login as Driver Test");      //main line1

        //test steps
        extentLogger.info("Open Chrome Browser");                                    //main line2
